...
public class FilterDispatcher implements Filter {
    ...
    private final String PAGE_NOT_FOUND = "pageNotFound.html";
...
//        doBeforeProcessing(request, response);
        ...
        String url = PAGE_NOT_FOUND;
        ServletContext context = (ServletContext) req.getServletContext();
        Map<String, String> servlets = (Map<String, String>) context.getAttribute("SERVLET_MAPPING");
...
//        Throwable problem = null;
        try {
            ...
            if (resource.length() > 0) {
                    if (servlets.containsKey(resource)) {
