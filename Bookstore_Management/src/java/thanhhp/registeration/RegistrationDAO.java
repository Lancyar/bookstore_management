...
public class RegistrationDAO implements Serializable{
    public int checkLogin(String username, String password) 
        ...
        try {
            ...
            if (con != null) {
               //2. Create SQL String
               String sql = "SELECT username, isAdmin "
                       + "FROM thanhhp "
               ...
               //5. Process result
               if (rs.next()) {
                   boolean chkAdmin = rs.getBoolean("isAdmin");
                   if (chkAdmin) return 1;
                   else return 0;
               }//end if rs existed
        ...
        try {
            ...
            if (con != null) {
               ...
               String sql = "INSERT INTO "
                       + "thanhhp(username, password, lastname, isAdmin) "
                       + "VALUES(?, ?, ?, ?)";
    ...
    public String getFullName(String username) 
        ...
        try {
            ...
            if (con != null) {
               //2. Create SQL String
               String sql = "SELECT lastname FROM thanhhp WHERE username = ?";
